  ...
  return (
    ...
    >
      <div className="relative group">
        ...
        <div className="relative flex items-center bg-slate-900/90 backdrop-blur-xl text-white p-3 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-white/10">
